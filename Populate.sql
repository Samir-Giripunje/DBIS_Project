...
-- Endowment Plans
INSERT INTO
    Policy (policy_id, policy_name, policy_type, description)
VALUES
    (
        860,
        'Bima Jyoti',
...
: (65 years (Age Nearer Birthday) in case of policies procured through POSP-LI/CPSC-SPV)'
    ...
    (
        ...
        'Dhan Sanchay',
        'Endowment Plan',
        'i. Minimum Entry Age 3 years (completed)
...
VALUES
    (
        100,
        'Death Benefit',
        'Claim filed due to the policyholder demise'
    ),
    (
        101,
        'Hospitalization',
...
---------------------Verification-------------------------------
INSERT INTO
    Verification (person_id, adhar_number)
VALUES
    (1, 1234567),
    (2, 9876543),
    (27, 234567),
...
INSERT INTO
    Verification (person_id, adhar_number, bank_account, phone_number)
VALUES
